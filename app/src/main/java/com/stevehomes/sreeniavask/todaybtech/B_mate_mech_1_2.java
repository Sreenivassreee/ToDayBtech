...
public class B_mate_mech_1_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_mate_mech_1_2);

//        actionBar = getSupportActionBar();
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));


        mWebView = (WebView) findViewById(R.id.mate_mech_1_2_web);
...
//        toolbar.setLogo(R.drawable.tool_icon);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/i-year-i-sem-mechanical-materials.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_mate_mech_1_2.this);
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                try{
                    ...
                    Toast.makeText(B_mate_mech_1_2.this, "", Toast.LENGTH_SHORT).show();
