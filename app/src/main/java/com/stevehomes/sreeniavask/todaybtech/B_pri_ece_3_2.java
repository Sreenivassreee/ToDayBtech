...
public class B_pri_ece_3_2 extends AppCompatActivity {
...
ProgressDialog pDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_pri_ece_3_2);
...
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));
        ...
        mWebView = (WebView) findViewById(R.id.pri_ece_3_2_web);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/iii-year-ii-sem-ece-previous-questions.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_pri_ece_3_2.this);
