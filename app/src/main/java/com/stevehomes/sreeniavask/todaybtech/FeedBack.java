...
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));
        ...
        mWebView = (WebView) findViewById(R.id.FeedBack_web);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        if (savedInstanceState == null) {
            mWebView.loadUrl("https://todaybtech.wordpress.com/feedback/");
        }
...
//
    ...
    private void init() {
        ...
        pDialog.setMessage("DataBase Loading please wait...");
