...
public class B_pri_ece_3_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_pri_ece_3_1);
//
...
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));
        ...
        mWebView = (WebView) findViewById(R.id.pri_ece_3_1_web);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/blog-page_91.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_pri_ece_3_1.this);
