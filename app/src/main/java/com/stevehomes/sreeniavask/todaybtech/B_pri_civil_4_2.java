...
public class B_pri_civil_4_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_pri_civil_4_2);

//        actionBar = getSupportActionBar();
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));


        mWebView = (WebView) findViewById(R.id.pri_civil_4_2_web);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/iv-year-ii-sem-civil-previous-questions.html");
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_pri_civil_4_2.this);
