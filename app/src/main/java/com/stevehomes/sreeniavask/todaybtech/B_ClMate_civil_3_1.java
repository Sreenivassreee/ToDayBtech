...
public class B_ClMate_civil_3_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_cl_mate_civil_3_1);
...
//        toolbar.setLogo(R.drawable.tool_icoon);

//        toolbar.setNavigationIcon(R.drawable.back);

        mWebView = (WebView) findViewById(R.id.ClMate_civil_3_1_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/iii-year-i-sem-civil-class-notes.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_ClMate_civil_3_1.this);
