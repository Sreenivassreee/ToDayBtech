...
public class B_ClMate_ece_3_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_cl_mate_ece_3_2);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        mWebView = (WebView) findViewById(R.id.ClMate_ece_3_2_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/iii-year-ii-sem-ece-class-notes.html");
        }
...
//
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_ClMate_ece_3_2.this);
