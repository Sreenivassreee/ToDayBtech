...
public class B_syll_cse_2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_syll_cse_2_1);

//        actionBar=getSupportActionBar();
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));
        toolbar = findViewById(R.id.toolbar);
        mWebView = (WebView) findViewById(R.id.syll_cse_2_1_web);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        if (savedInstanceState == null) {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/i-year-i-sem-cse-syllabus-copy.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_syll_cse_2_1.this);
