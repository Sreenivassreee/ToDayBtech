...
public class B_ClMate_cse_3_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_cl_mate_cse_3_1);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        mWebView = (WebView) findViewById(R.id.ClMate_cse_3_1_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/to-day-b-tech-i-i-i-year-i-sem-cse_7.html");
        }
...
//
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_ClMate_cse_3_1.this);
