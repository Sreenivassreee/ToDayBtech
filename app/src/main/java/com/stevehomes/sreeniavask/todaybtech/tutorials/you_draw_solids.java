...
public class you_draw_solids extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.you_draw_solids);
        ...
        {
            mWebView.loadUrl("https://m.youtube.com/playlist?list=PLIhUrsYr8yHwAbiCATZUbzd_CpF0EHF3v");
        }
