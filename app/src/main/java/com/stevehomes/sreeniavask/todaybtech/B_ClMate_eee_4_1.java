...
public class B_ClMate_eee_4_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_cl_mate_eee_4_1);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        mWebView = (WebView) findViewById(R.id.ClMate_eee_4_1_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/i-year-i-sem-eee-class-notes_89.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_ClMate_eee_4_1.this);
