...
public class B_syll_eee_3_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_syll_eee_3_1);
...
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));
        ...
        mWebView = (WebView) findViewById(R.id.syll_eee_3_1_web);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        if (savedInstanceState == null) {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/iii-year-i-sem-ece-syllabus-copy_26.html");
        }
...
//
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_syll_eee_3_1.this);
