...
public class B_mate_cse_1_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_mate_cse_1_2);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        mWebView = (WebView) findViewById(R.id.mate_cse_1_2_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/blog-page_29.html");
        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_mate_cse_1_2.this);
