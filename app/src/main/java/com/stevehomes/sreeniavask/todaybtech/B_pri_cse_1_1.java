...
public class B_pri_cse_1_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_pri_cse_1_1);
...
//        toolbar.setNavigationIcon(R.drawable.back);
     ...
     ;
        mWebView = (WebView) findViewById(R.id.pri_cse_1_1_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/i-year-i-sem-mechanical-materials_8.html");
        }
...
//
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_pri_cse_1_1.this);
        pDialog.setTitle("Please Wait...");
        pDialog.setMessage("Wait for few seconds till the PDF file loads...");
        pDialog.setIndeterminate(false);
        pDialog.setCancelable(true);
        //mWebView.loadUrl("https://stackoverflow.com/questions/2655972/how-can-i-display-a-pdf-document-into-a-webview");
