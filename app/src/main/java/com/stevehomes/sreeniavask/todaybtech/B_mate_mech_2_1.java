...
public class B_mate_mech_2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_mate_mech_2_1);

//        actionBar = getSupportActionBar();
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));


        mWebView = (WebView) findViewById(R.id.mate_mech_2_1_web);
...
//        toolbar.setLogo(R.drawable.tool_icon);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/blog-page_96.html");
        }
...
//
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_mate_mech_2_1.this);
