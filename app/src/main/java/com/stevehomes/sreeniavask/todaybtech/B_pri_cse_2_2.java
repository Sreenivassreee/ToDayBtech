...
public class B_pri_cse_2_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_pri_cse_2_2);

//        actionBar = getSupportActionBar();
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));


        mWebView = (WebView) findViewById(R.id.pri_cse_2_2_web);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/ii-year-ii-sem-previous-questions-papers.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_pri_cse_2_2.this);
