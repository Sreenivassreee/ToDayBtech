...
public class you_draw_lines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.you_draw_lines);
        toolbar=findViewById(R.id.toolbar);
        mWebView = (WebView) findViewById(R.id.b_draw_lines_web);
        ...
        {
            mWebView.loadUrl("https://m.youtube.com/playlist?list=PLIhUrsYr8yHz_FkG5tGWXaNbIxVcibQvV");
        }
