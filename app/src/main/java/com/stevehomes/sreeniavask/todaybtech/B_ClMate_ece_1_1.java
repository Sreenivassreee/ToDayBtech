...
public class B_ClMate_ece_1_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_cl_mate_ece_1_1);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        mWebView = (WebView) findViewById(R.id.ClMate_ece_1_1_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/i-year-i-sem-cse-class-notes.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_ClMate_ece_1_1.this);
