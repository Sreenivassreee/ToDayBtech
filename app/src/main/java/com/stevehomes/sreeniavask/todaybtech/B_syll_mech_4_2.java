...
public class B_syll_mech_4_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_syll_mech_4_2);

//        actionBar = getSupportActionBar();
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));


        mWebView = (WebView) findViewById(R.id.syll_mech_4_2_web);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        if (savedInstanceState == null) {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/i-year-i-sem-mech-syllabus-copy_32.html");
        }
...
//
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_syll_mech_4_2.this);
