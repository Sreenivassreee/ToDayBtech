...
public class B_syll_eee_2_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_syll_eee_2_2);
        mWebView = (WebView) findViewById(R.id.syll_eee_2_2_web);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        if (savedInstanceState == null) {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/ii-year-ii-sem-ee-syllabus-copy.html");
        }
...
//
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_syll_eee_2_2.this);
