...
public class B_ClMate_ece_2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_cl_mate_ece_2_1);
...
//        toolbar.setLogo(R.drawable.tool_icon);
        ...
        mWebView = (WebView) findViewById(R.id.ClMate_ece_2_1_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/to-day-b-tech-i-i-i-year-i-sem-ece.html");
        }
...
////
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_ClMate_ece_2_1.this);
