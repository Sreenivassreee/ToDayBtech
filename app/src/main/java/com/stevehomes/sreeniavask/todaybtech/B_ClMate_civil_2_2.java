...
public class B_ClMate_civil_2_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_cl_mate_civil_2_2);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        mWebView = (WebView) findViewById(R.id.ClMate_civil_2_2_web);
...
//        webSettings.setBuiltInZoomControls(true);
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                prDialog = ProgressDialog.show(B_ClMate_civil_2_2.this, null, "loading, please wait...");
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/to-day-b-tech-i-i-i-year-i-sem-civil.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_ClMate_civil_2_2.this);
