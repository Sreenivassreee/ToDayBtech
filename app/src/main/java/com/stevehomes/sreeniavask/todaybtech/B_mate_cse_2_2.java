...
public class B_mate_cse_2_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_mate_cse_2_2);
        toolbar=findViewById(R.id.toolbar);
//        actionBar = getSupportActionBar();
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));


        mWebView = (WebView) findViewById(R.id.mate_cse_2_2_web);
...
//        toolbar.setLogo(R.drawable.tool_icon);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/blog-page_51.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_mate_cse_2_2.this);
