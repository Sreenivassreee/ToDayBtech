...
public class B_ClMate_mech_3_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_cl_mate_mech_3_2);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        mWebView = (WebView) findViewById(R.id.ClMate_mech_3_2_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/to-day-b-tech-iii-ii-iii-year-i-sem.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_ClMate_mech_3_2.this);
