...
public class B_ClMate_mech_2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_cl_mate_mech_2_1);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        mWebView = (WebView) findViewById(R.id.ClMate_mech_2_1_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/ii-year-i-sem-mech-class-notes.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_ClMate_mech_2_1.this);
