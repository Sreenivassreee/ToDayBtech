...
public class B_ClMate_cse_4_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_cl_mate_cse_4_2);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        mWebView = (WebView) findViewById(R.id.ClMate_cse_4_2_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/iv-year-i-sem-cse-class-notes.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_ClMate_cse_4_2.this);
