...
public class B_pri_cse_2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_pri_cse_2_1);

//        actionBar = getSupportActionBar();
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));


        mWebView = (WebView) findViewById(R.id.pri_cse_2_1_web);

        toolbar = findViewById(R.id.toolbar);


        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Previous Quation Papers");
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/blog-page_8.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_pri_cse_2_1.this);
