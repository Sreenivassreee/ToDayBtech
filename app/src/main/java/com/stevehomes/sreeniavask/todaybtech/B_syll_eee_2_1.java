...
public class B_syll_eee_2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_syll_eee_2_1);
...
//        toolbar.setLogo(R.drawable.tool_icon);
        mWebView = (WebView) findViewById(R.id.syll_eee_2_1_web);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        if (savedInstanceState == null) {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/ii-year-i-sem-ece-syllabus-copy_26.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_syll_eee_2_1.this);
