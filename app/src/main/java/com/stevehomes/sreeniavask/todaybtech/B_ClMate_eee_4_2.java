...
public class B_ClMate_eee_4_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_cl_mate_eee_4_2);
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        mWebView = (WebView) findViewById(R.id.ClMate_eee_4_2_web);
        ...
        {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/to-day-b-tech-iv-i-i-year-i-sem-eee.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_ClMate_eee_4_2.this);
