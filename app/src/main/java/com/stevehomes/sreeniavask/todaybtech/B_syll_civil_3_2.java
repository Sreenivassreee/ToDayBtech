...
public class B_syll_civil_3_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_syll_civil_3_2);
...
//        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#212121")));
        ...
        mWebView = (WebView) findViewById(R.id.syll_civil_3_2_web);
        ...
        getSupportActionBar().setTitle("Syllabus || Important Q");
...
//        toolbar.setNavigationIcon(R.drawable.back);
        ...
        if (savedInstanceState == null) {
            mWebView.loadUrl("https://todaybtech.blogspot.com/p/iii-year-ii-sem-civil-syllabus-copy.html");
        }
...
//        }
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(B_syll_civil_3_2.this);
